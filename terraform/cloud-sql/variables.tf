...
variable name {
  description = "Name for the database instance. If the name is left blank, Terraform will randomly generate one when the instance is first created. Must be unique and cannot be reused for up to one week."
}

variable database_version {
  description = "The version of of the database. For example, `MYSQL_5_6`, `MYSQL_5_7` or `POSTGRES_9_6`."
  default     = "MYSQL_5_7"
}

variable tier {
  description = "The machine tier (First Generation) or type (Second Generation). See this page for supported tiers and pricing: https://cloud.google.com/sql/pricing. Second Generation is preferred."
